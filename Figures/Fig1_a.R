...
prob_CMS<- read.table("/Users/leandromoreno/Desktop/annotation_PM_prob2.txt", sep="\t",header = TRUE,row.names = 1,check.names=FALSE)
...
pdf(file="/Users/leandromoreno/Desktop/ssp500_colored_kristiaan.pdf") # or other device
